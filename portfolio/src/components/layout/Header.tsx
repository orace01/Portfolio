...
export default function Header() {
  ...
  return (
    <header data-intro="interface" className="liquid-glass sticky top-0 z-30 border-b border-white/[0.08]">
      <div className="mx-auto flex max-w-[1600px] items-center justify-between px-4 py-5 sm:px-8">
        ...
        <NavLink
          to="/contact"
          className="liquid-glass overflow-hidden rounded-full border border-cyan-neon/50 px-6 py-2.5 font-mono text-sm uppercase tracking-[0.15em] text-cyan-neon transition-all duration-300 hover:scale-105 hover:border-cyan-neon hover:shadow-[0_0_15px_rgba(0,240,255,0.2)]"
          {...contactReaction}
        >
          [ CONTACT ]
        </NavLink>
