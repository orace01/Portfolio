...
export default function Footer() {
  return (
    <footer data-intro="interface" className="relative z-10 mt-auto border-t border-white/10 bg-void/70 backdrop-blur-xl">
      <div className="mx-auto flex max-w-[1600px] flex-col items-center gap-3 px-4 py-6 text-sm text-slate-400 sm:flex-row sm:justify-between sm:px-8">
        ...
        <p className="text-slate-500">DESIGNED BY AI. GUIDED BY CAINE.</p>
      </div>
    </footer>
  )
}
